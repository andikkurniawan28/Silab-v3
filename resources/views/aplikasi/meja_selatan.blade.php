                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Penilaian Tebu Meja Selatan</h1>
                                    </div>

                                    <form method="POST" action="{{ route('proses_meja_selatan') }}" class="text-dark" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
