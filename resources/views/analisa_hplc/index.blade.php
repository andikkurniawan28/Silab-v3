...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">{{ ucfirst('analisa HPLC') }}</h5>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog" sample="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('analisa_hplc_store') }}" class="text-dark">
                @csrf
                @method('POST')
...
<div class="modal fade" id="delete{{ $sample->id }}" tabindex="-1" analysis="dialog" aria-labelledby="delete{{ $sample->id }}Label" aria-hidden="true">
    <div class="modal-dialog" analysis="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form method="POST" action="{{ route('analisa_hplc_delete') }}" class="text-dark">
                @csrf
                @method('POST')
