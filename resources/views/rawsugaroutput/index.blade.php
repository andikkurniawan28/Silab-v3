...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">{{ ucfirst('timbangan rawsugar output') }}</h5>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog" rawsugaroutput="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createLabel">Tambah {{ ucfirst('timbangan rawsugar output') }}</h5>
...
<div class="modal fade" id="edit{{ $rawsugaroutput->id }}" tabindex="-1" rawsugaroutput="dialog" aria-labelledby="edit{{ $rawsugaroutput->id }}Label" aria-hidden="true">
    <div class="modal-dialog" rawsugaroutput="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="edit{{ $rawsugaroutput->id }}Label">Edit {{ ucfirst('timbangan rawsugar output') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="delete{{ $rawsugaroutput->id }}" tabindex="-1" rawsugaroutput="dialog" aria-labelledby="delete{{ $rawsugaroutput->id }}Label" aria-hidden="true">
    <div class="modal-dialog" rawsugaroutput="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete{{ $rawsugaroutput->id }}Label">Hapus {{ ucfirst('timbangan rawsugar output') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
